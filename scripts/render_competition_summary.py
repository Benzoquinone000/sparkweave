    ...
    if failed:
        ...
        lines.extend(
            [
                ...
                "- 正式提交前建议再运行 `sparkweave competition-preflight --with-build --report dist/competition-readiness.json --summary dist/competition-readiness.md --archive dist/sparkweave_competition_package.zip --verify-report dist/competition-package-verify.json`。",
            ]
        )
