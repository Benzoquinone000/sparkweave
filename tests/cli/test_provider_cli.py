...
CLI_README = (ROOT / "sparkweave_cli" / "README.md").read_text(encoding="utf-8")
...
class ProviderCliDocsContractTest(unittest.TestCase):
    ...
    def test_readmes_match_the_cli_contract(self) -> None:
        ...
        self.assertIn('sparkweave provider login github-copilot    # 校验现有 GitHub Copilot 认证是否可用', CLI_README)
