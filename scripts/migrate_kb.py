...
Migrate existing knowledge bases into SparkWeave's knowledge base system.
...
async def migrate_kb(
    ...
    """
    Migrate a knowledge base to SparkWeave.
    ...
    print(f"  Knowledge base '{kb_name}' is now available in SparkWeave.")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Migrate knowledge bases into SparkWeave",
