...
class SparkBotManager:
    ...
    def set_cron_job_enabled(self, bot_id: str, job_id: str, enabled: bool) -> dict[str, Any] | None:
        job = self._cron_service_for(bot_id).enable_job(job_id, enabled=enabled)
    ...
    def read_bot_skill(self, bot_id: str, skill_name: str) -> dict[str, Any] | None:
        ...
        summary = summaries.get(safe_name, {"name": safe_name, "source": "workspace", "editable": True})
