...
export function Metric({
  ...
  return (
    <div className="dt-soft-enter dt-dynamic-metric inline-flex min-w-0 max-w-full items-center gap-1.5 rounded-md border border-line bg-white px-2 py-1 text-xs">
