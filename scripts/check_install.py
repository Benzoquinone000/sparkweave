#!/usr/bin/env python
"""
SparkWeave Installation Checker
...
def main():
    """Main function"""
    print("\n" + "=" * 60)
    print("🔍 SparkWeave Installation Checker")
    print("=" * 60)
    ...
    if all_checks_passed:
        ...
        print_info("Recommended startup: docker compose up --build")
        print_info("Frontend/backend run as split hot-reload services by default.")
    else:
        print_error("Some dependencies are missing!")
        print_info("Docker deployment only needs Docker Desktop and a configured .env file.")
        print_info("See README.md for the Docker Compose startup commands.")
