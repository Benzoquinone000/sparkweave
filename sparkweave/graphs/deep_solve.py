...
class DeepSolveGraph:
                ...
                response = await model.ainvoke(
                    chat_messages(
                        system=(
                            ...
                            "When calling `rag`, choose `retrieval_profile`: fast "
                            "for bare terms/acronyms with no explanation request, exact "
                            "for source text or definitions, code for APIs/functions/errors, "
                            "formula for proofs or derivations, broad for multi-hop "
                            "comparison, guide for learning plans, "
                            "and concept when unsure. Do not guess dense or hybrid index type."
                        ),
                        user=(
    ...
    async def _execute_tool_call(
        ...
        return await self.tool_executor.execute(call, context, stream)
