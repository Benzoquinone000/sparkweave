...
export interface LearnerProfileSnapshot {
  ...
  quantification?: {
    ...
    >;
    preference_scores?: Array<Record<string, unknown>>;
    weakness_scores?: Array<Record<string, unknown>>;
    mastery_scores?: Array<Record<string, unknown>>;
...
export type GuideV2ResourceType = "visual" | "video" | "audio" | "external_video" | "external_image" | "quiz" | "research";
...
export interface ExternalImageRecommendation {
  title?: string;
  url?: string;
  image_url?: string;
  thumbnail?: string;
  source?: string;
  kind?: "image" | "search_fallback" | string;
  summary?: string;
  width?: number | null;
  height?: number | null;
  license?: string;
...
export interface ExternalImageResult {
  success?: boolean;
  render_type?: "external_image" | string;
  response?: string;
  view_plan?: string[];
  reflection_prompt?: string;
  learner_profile_hints?: Record<string, unknown>;
  style_hint?: string;
  images?: ExternalImageRecommendation[];
  queries?: string[];
  search_errors?: string[];
  fallback_search?: boolean;
  agent_chain?: Array<{ label?: string; detail?: string }>;
...
export interface SparkBotCronSchedule {
...
export interface SparkBotCronPayload {
  kind?: string;
  message?: string;
  deliver?: boolean;
  channel?: string | null;
...
export interface SparkBotCronJob {
  id: string;
  name: string;
  enabled: boolean;
  ...
  state?: {
    ...
    lastStatus?: "ok" | "error" | "skipped" | string | null;
...
export interface SparkBotCronResponse {
  status?: {
    enabled?: boolean;
    jobs?: number;
    next_wake_at_ms?: number | null;
  };
  jobs: SparkBotCronJob[];
}
...
export interface SparkBotSkill {
  name: string;
