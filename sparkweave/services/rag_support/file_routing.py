...
logger = logging.getLogger("sparkweave.rag.file_routing")
...
class FileTypeRouter:
    ...
    def classify_files(cls, file_paths: List[str]) -> FileClassification:
        ...
        for path in file_paths:
            ...
            if doc_type in (DocumentType.PDF, DocumentType.IMAGE, DocumentType.DOCX):
    ...
    def get_supported_extensions(cls) -> set[str]:
        ...
        return cls.PARSER_EXTENSIONS | cls.TEXT_EXTENSIONS | cls.IMAGE_EXTENSIONS | cls.DOCX_EXTENSIONS
