...
from sparkweave.services.llm import LLMConfig, RoutingProvider
...
def test_routing_provider_local_complete(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "sparkweave.services.llm.local_complete",
...
def test_routing_provider_cloud_complete(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "sparkweave.services.llm.cloud_complete",
...
def test_routing_provider_stream(monkeypatch) -> None:
    ...
    monkeypatch.setattr("sparkweave.services.llm.local_stream", _fake_stream)
