"""Knowledge-base configuration service owned by ``sparkweave``."""
...
class KnowledgeBaseConfigService:
    """Read and write ``data/knowledge_bases/kb_config.json``."""
    ...
    def _load_config(self) -> dict[str, Any]:
        ...
        if self.config_path.exists():
            try:
                loaded = json.loads(self.config_path.read_text(encoding="utf-8")) or {}
