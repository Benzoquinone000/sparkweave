...
async def test_profile_context_injector_builds_compact_prompt_block() -> None:
    service = FakeProfileService(
        {
            ...
            "quantification": {
                ...
                "next_action_priority": 0.81,
                "axes": {
                    "evidence": {"score": 0.72},
                    "weakness": {"score": 0.79},
                    "mastery": {"score": 0.48},
                    "preference": {"score": 0.66},
                },
            },
    ...
    assert payload["hints"]["decision_scores"]["weakness"] == 0.79
    assert payload["hints"]["decision_scores"]["next_action_priority"] == 0.81
    ...
    assert "decision_scores" in payload["text"]
