...
- Start the SparkWeave Docker stack

## Prerequisites

- Docker Desktop with Docker Compose v2
- `.env` copied from `.env.example` and configured with LLM / embedding providers
...
docker compose up -d --build                    # Start the full SparkWeave stack
```
