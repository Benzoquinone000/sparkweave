...
def _load_start_tour_module():
    ...
    sparkweave_pkg = types.ModuleType("sparkweave")
    services_pkg = types.ModuleType("sparkweave.services")
    config_module = types.ModuleType("sparkweave.services.config")
    ...
    original_modules = {
        ...
        "sparkweave": sys.modules.get("sparkweave"),
        "sparkweave.services": sys.modules.get("sparkweave.services"),
        "sparkweave.services.config": sys.modules.get("sparkweave.services.config"),
    }

    services_pkg.config = config_module
    sparkweave_pkg.services = services_pkg
    sys.modules["_cli_kit"] = cli_kit
    sys.modules["sparkweave"] = sparkweave_pkg
    sys.modules["sparkweave.services"] = services_pkg
    sys.modules["sparkweave.services.config"] = config_module
