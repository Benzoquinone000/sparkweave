...
def register(app: typer.Typer) -> None:
    ...
    def chat(
        ...
        session: Optional[str] = typer.Option(
            None, "--session", help="Resume an existing session."
        ),
        ...
        """Enter interactive chat REPL. Use `sparkweave run` for single-turn execution."""
