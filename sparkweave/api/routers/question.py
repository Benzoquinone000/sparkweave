...
from sparkweave.services.question_generation import AgentCoordinator, mimic_exam_questions
            ...
            try:
                ...
                if result_context is not None:
                    logger.error(
                        ...
                        type(result_context),
                        result_context.keys() if isinstance(result_context, dict) else "N/A",
                    )
