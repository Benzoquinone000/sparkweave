"""Web Search Service with SparkBot-style provider selection."""
...
_logger = logging.getLogger("sparkweave.search")
...
def web_search(
    ...
    **provider_kwargs: Any,
    ...
    """Execute web search and return SparkWeave structured response shape.
    ...
    _logger.info("[%s] Searching: %s...", search_provider.name, query[:50])
    try:
