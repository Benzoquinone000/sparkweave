  ...
  return (
    <section className="rounded-lg border border-blue-100 bg-white p-4 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="h-10 w-28 rounded-lg bg-slate-100" />
      </div>
    </section>
  );
}
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/25">
      <button
        ...
        onClick={onClose}
      />
      <aside className="absolute right-0 top-0 h-full w-full max-w-[430px] overflow-y-auto bg-canvas p-4 shadow-2xl">
