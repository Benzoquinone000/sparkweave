...
from sparkweave.runtime.context_enrichment import (
...
from sparkweave.runtime.turn_runtime import _should_capture_assistant_content
...
class TestFormatFollowupQuestionContext:
    ...
    def test_chinese_format(self) -> None:
        ...
        assert "Question Follow-up Context" in text
        assert "What is 2+2?" in text
