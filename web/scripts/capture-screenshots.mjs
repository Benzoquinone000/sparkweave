...
const learnerProfile = {
  ...
  recommendations: ["先用一张图解释 CNN 图像检索，再做 3 道小题确认。"],
  next_action: {
    title: "前测补基：CNN 图像检索流程",
    suggested_prompt: "我想用 10 分钟补齐 CNN 图像检索流程，先看图解再做练习。",
...
const guideV2CourseTemplates = [
  {
    ...
    default_goal: "系统学习深度学习，先补齐 CNN、注意力机制、Transformer 和大模型应用。",
    default_preferences: ["visual", "practice"],
    default_time_budget_minutes: 45,
    demo_seed: {
      title: "深度学习课程学习样例",
      scenario: "从 CNN 图解开始，接入图像检索案例，再过渡到注意力、Transformer 和大模型应用。",
      task_chain: [
        { task_id: "D3", title: "生成 CNN 结构图" },
        { task_id: "D5", title: "搭建 CNN 图像检索流程" },
        { task_id: "D10", title: "拆解一个大模型应用链路" },
      ],
    },
  },
  {
    id: "intelligent_robot_systems",
    title: "完整课程：智能机器人系统",
    course_id: "ROBOT301",
    course_name: "智能机器人系统",
    description: "从机器人系统组成、运动控制、传感导航到 ROS 通信、TF/URDF 和导航应用。",
    level: "intermediate",
    suggested_weeks: 11,
    credits: 3,
    estimated_minutes: 820,
    default_goal: "系统学习智能机器人系统，完成一个基于 ROS 的机器人导航项目报告。",
