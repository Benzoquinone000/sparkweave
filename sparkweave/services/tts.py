...
def _decode_provider_base64(value: str, field_name: str) -> bytes:
    try:
        return base64.b64decode(value, validate=True)
    except (binascii.Error, ValueError) as exc:
        raise TtsUnavailable(f"iFlytek TTS returned invalid base64 {field_name}") from exc
                ...
                if isinstance(payload_block, dict):
                    ...
                    if isinstance(audio_block, dict):
                        ...
                        if isinstance(encoded_audio, str) and encoded_audio:
                            audio_chunks.append(
                                _decode_provider_base64(encoded_audio, "audio")
                            )
                    ...
                    if isinstance(pybuf, dict):
                        ...
                        if isinstance(encoded_text, str) and encoded_text:
                            pybuf_parts.append(
                                _decode_provider_base64(encoded_text, "pybuf text").decode(
