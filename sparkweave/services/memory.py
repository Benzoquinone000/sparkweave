...
def create_memory_service(
    *,
    ...
    """Create an isolated memory service for tests or NG runtimes."""
    return MemoryService(path_service=path_service, store=store)


def get_memory() -> MemoryService:
    """Return the shared memory service used by the current process."""
