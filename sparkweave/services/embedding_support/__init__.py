...
Unified embedding client for all SparkWeave modules.
Supports normalized providers: custom/openai/azure_openai/cohere/jina/ollama/vllm.

Usage:
    from sparkweave.services.embedding_support import get_embedding_client, EmbeddingClient, EmbeddingConfig
