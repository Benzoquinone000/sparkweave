        ...
        <section className="mt-3 space-y-2">
          ...
          {videos.map((item) => (
            <video
              ...
              playsInline
              preload="metadata"
              src={authenticatedResourceUrl(item.url)}
              className="mx-auto aspect-video w-full max-w-xl rounded-lg border border-line bg-black object-contain"
            />
          ))}
        </section>
      ) : null}
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {images.map((item) => (
              <img
                ...
                className="max-h-60 w-full rounded-lg border border-line bg-white object-contain"
              />
            ))}
          </div>
        </section>
