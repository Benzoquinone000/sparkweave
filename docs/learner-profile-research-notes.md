...
### 2026-05-02 在线调研补充：画像要变成行动，而不是报表

近期学习分析仪表盘研究反复强调：仪表盘只有在能降低学习者解释成本、给出可执行反馈，并允许学习者理解/修正系统判断时，才更可能帮助学习。UNESCO 2024 学生 AI 能力框架也把人本、伦理、理解与共同创造放在核心位置。对 SparkWeave 的直接启发：

- 画像首页继续坚持“现在只做这一件事”，不要把全部指标平铺成报表。
- 原始证据、事件日志、工具轨迹应放到次级页面或折叠区，主流程只展示行动建议和少量理由。
- 反馈语言要从“系统检测到若干信号”改成“你接下来应该做什么、为什么这样做”。
- 画像校准必须是显式能力：学习者能说“这里不准”，系统把校准纳入后续导学和资源推荐。
- 推荐资源时优先考虑学习者偏好和现实可用性，例如偏好公开课时先找精选公开视频，偏好练习时先给可提交小题。
...
- Design Principles and Impact of a Learning Analytics Dashboard: Evidence from a Randomized MOOC Experiment: https://www.mdpi.com/2076-3417/15/21/11493
