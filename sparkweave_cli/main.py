...
def run_capability(
    ...
    config_json: Optional[str] = typer.Option(
        None,
        "--config-json",
        help="Capability config as JSON.",
    ),
...
def serve(
    ...
    # Windows: uvicorn defaults to SelectorEventLoop, which cannot run the
    # subprocess APIs used by renderers. Proactor keeps CLI/server parity.
    ...
    try:
        ...
        console.print(
            ...
            "Install the server dependencies before running this command."
        )
