...
def _get_embedding_fingerprint() -> tuple[str, int] | None:
    ...
    try:
        from sparkweave.services.embedding import get_embedding_config
...
class KnowledgeBaseManager:
    ...
    def delete_knowledge_base(self, name: str, confirm: bool = False) -> bool:
        ...
        if not confirm:
            ...
            print(f"鈿狅笍  Warning: This will permanently delete the knowledge base '{name}'")
            print(f"   Path: {kb_dir}")
...
def main():
    ...
    if args.command == "list":
        ...
        try:
            ...
            print(f"鉁?Set '{args.name}' as default knowledge base")
        except Exception as e:
            print(f"Error: {e!s}")
        ...
        try:
            ...
            if success:
                print(f"鉁?Deleted knowledge base '{args.name}'")
        except Exception as e:
            print(f"Error: {e!s}")
