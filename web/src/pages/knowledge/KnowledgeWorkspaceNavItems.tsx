...
export function buildKnowledgeWorkspaceNavItems({
  ...
  return [
    ...
    },
    {
      id: "test",
      title: "问资料",
      description: "用一个真实问题确认能否找到依据。",
      icon: <Search size={18} />,
      badge: testSourceCount == null ? "试问" : `${formatWorkspaceCount(testSourceCount)} 条依据`,
